	...
	switch (state) {
		case "input-streaming":
			return {
				...
				icon: Loader2,
				rowTone: "border-border/60 bg-muted/20 text-foreground",
				badgeTone: "border-border/60 bg-background/80 text-muted-foreground",
...
function ToolTraceRow({ part, isLive }: { part: ToolPart; isLive: boolean }) {
		...
		<Collapsible open={open} onOpenChange={setOpen}>
			...
			>
				...
				>
					...
					>
						<Icon
							className={cn("size-3", meta.spin && isLive && "animate-spin")}
						/>
					</span>
